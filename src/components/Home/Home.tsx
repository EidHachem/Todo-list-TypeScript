...
import { FaList, FaMoneyBill, FaPen } from 'react-icons/fa';
...
const Home = () => {
  return (
    <div>
      ...
      <div className="mx-auto max-w-[25%] grid grid-cols-2 gap-5">
        ...
        <Link to="/notes" className="hover:scale-110">
          <div className="border-2 border-white flex flex-col items-center justify-center gap-4 py-10">
            <FaPen className="text-6xl text-orange-600 mx-auto block" />
